...
import { AreaPixedType, unCroppedImg } from "./page";

type Props = {
    croppedImage: unCroppedImg;
    setCroppedAreaPixels: Dispatch<SetStateAction<AreaPixedType>>;
    cropperModal: boolean;
    handleCropImage: () => void;
};

const ImageCropper = ({ croppedImage, setCroppedAreaPixels, cropperModal, handleCropImage }: Props) => {
